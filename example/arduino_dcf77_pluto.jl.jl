...
# ╔═╡ b61fed3d-08d3-40d6-b0a4-52e4bbe6e39f
using Plots: Plots
...
rsignal = collect(reinterpret(Int16, read("signal.dat")))
...
function read_and_decode(signal::AbstractVector{<:Integer}, milliseconds::Real; threshold::Signed=400)
    ...
    @info "Setup" second_length zero_length one_length
...
manifest_format = "2.0"
project_hash = "91211e6d49df0536cf874514f2609381d3b39e4c"
...
git-tree-sha1 = "2d38cdf7f3629b767ef9be3d4943f2ddba549a58"
repo-rev = "main"
repo-url = "../../../../../../../../Users/mose/.julia/dev/RadioClock"
uuid = "494dee28-fb50-4d66-82c2-2f703a44d82e"
version = "0.1.0"
