...
@testset "DCF77" begin
    ...
    @testset "Encoder" begin
        @test encode(DCF77, 2025,  7, 17, 20, 48) == DCF77Data("000000000000000001001000100100000011111010001111001010010010")
        @test encode(DCF77, 2019,  6, 16, 14, 32) == DCF77Data("000000000000000001001010011010010100011010111011001001100010")
        @test encode(DCF77, 2009,  6, 13, 10, 09) == DCF77Data("000000000000000001001100100000000101110010011011001001000010")
        @test encode(DCF77, 2000, 10,  7,  3, 59) == DCF77Data("000000000000000001001100110101100000111000011000010000000000")
        @test encode(DCF77, 2033,  2, 23, 11, 49) == DCF77Data("000000000000000000101100100111000100110001110010001100110000")
        @test encode(DCF77, ZonedDateTime(2024, 10, 27,  2, 46, tz"Europe/Berlin", 1)) == DCF77Data("000000000000000011001011000110100001111001111000010010010000")
        @test encode(DCF77, ZonedDateTime(2024, 10, 27,  1, 46, tz"Europe/London", 2)) == DCF77Data("000000000000000000101011000110100001111001111000010010010000")
        @test encode(DCF77, ZonedDateTime(2006,  4,  1, 23,  3, tz"America/New_York")) == DCF77Data("000000000000000001001110000000110000010000111001000110000010")
    end
